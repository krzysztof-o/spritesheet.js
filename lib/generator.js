...
var _extrudeCommand = function (inputFile, outputFile, extrude) {
    ...
    var command = 'convert -resize ' + resize + ' -define png:exclude-chunks=date "' + inputFile + '" -set option:distort:viewport ' + viewport + ' -virtual-pixel Edge -distort SRT 0 +repage ' + outputFile;
